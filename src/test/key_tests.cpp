...
static const std::string addr1 = "Af2iUrKqQEDdrMWDsDYuU68WFLG9QXSB5F"; //1QFqqMUD55ZV3PJEJZtaKCsQmjLT6JkjvJ";
static const std::string addr2 = "AVrqiivsgkjhobWsjoMfjMu9Ws9eaWfJ7o"; //1F5y5E5FMc5YzdJtB9hLaUe43GDxEKXENJ";
static const std::string addr1C = "AdaBWJjWHXqUUAVtsB7PSTtQL8LvTwkyA9"; //1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs";
static const std::string addr2C = "ATCbfnpyLMBfoFNWu4Z3REEn9yNqsN9n4Y"; //"1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs";
