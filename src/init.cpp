...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/auroraborealiscoin/auroraborealis>";
    const std::string URL_WEBSITE = "<https://auroraborealiscoin.com/>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Aurora Borealis version %s\n", FormatFullVersion());
}
