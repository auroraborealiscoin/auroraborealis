...
Setup
-----
Unpack the files into a directory and run auroraborealis-qt.exe.

Aurora Borealis Core is the reference client and provides the core software used to participate in the Aurora Borealis Coin network.
