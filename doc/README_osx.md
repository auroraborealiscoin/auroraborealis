...
- The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signing material, when used for an Aurora Borealis release, must come from the official Aurora Borealis release process and must be verified against the intended release commit.
